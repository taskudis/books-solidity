...
contract LIB is ERC20PresetMinterPauser {
	...
	function checkPermit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s, uint nonce) external view returns (address) {
